...
const Junior = () => (
  <Layout>
    ...
    >
      <div>
        <Image src={property1} className="junior-property" />
      ...
      <div>
        <Image src={property2} className="junior-property" />
        <Text className="junior-property--bold">02 팀 중심 활동</Text>
        <Text className="junior-property--light">
          PROB junior 는 각 포지션에 맞게 꾸려진 팀 별로 프로젝트, 모각코 활동을
          진행합니다.
        </Text>
      </div>
      <div>
        <Image src={property3} className="junior-property" />
      ...
      <div>
        <Image src={property4} className="junior-property" />
        <Text className="junior-property--bold">04 신뢰할 수 있는 동료</Text>
        <Text className="junior-property--light">
