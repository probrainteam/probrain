...
const IndexPage = () => {
  ...
  const activityInfo = [
    ...
    },
    {
      ...
      detail:
        '개발을 하고싶더라도 막상 시작하기는 쉽지 않아요. 프로브레인은 여러분들이 효율적으로 공부할 수 있도록 도와드릴 수 있어요. 자체적으로 진행하는 웹 교육을 통해 여러분들의 개발을 시작해보세요. 프로브레인의 개발 스터디 그룹인 PROB junior에서는 세미나를 개최하고 팀 단위로 프로젝트도 해볼 수 있어요.',
    ...
    },
    {
      ...
      detail:
        '프로브레인은 여러분들이 최신 기술을 사용하고 공부할 수 있도록 Web 개발 대회를 개최해요. 자신이 성장하는 발판을 마련하는 것뿐 아니라 성과를 이루어 친구들과 상도받고 기쁨을 나눌 수 있는 소중한 경험을 쌓을수 있을거에요.',
